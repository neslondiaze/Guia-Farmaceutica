...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupGrid() {
        ...
        categories.add(new Category("Impresión Diagnóstica", R.drawable.ic_cat_stethoscope, "cat_impresion_diagnostica"));
    ...
    static class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(v -> {
                ...
                } else if ("cat_calculadora".equalsIgnoreCase(cat.type)) {
                    v.getContext().startActivity(new Intent(v.getContext(), CalculadoraActivity.class));
